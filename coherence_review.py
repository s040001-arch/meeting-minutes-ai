...
def _build_system_prompt(
    ...
    static_prompt = (
        ...
        "同一人物を指すはずの姓が近接発言で別表記になる聞き取り揺れ"
        "（例: 『山口という』の直後に『川口さんか』）も F として検出し、"
        "文脈で確定できなければ medium でユーザー確認に回す"
        ...
        "\n\n【頻出2字同音ペア（文脈で判定し候補提示する）】"
        "\n- 『個数』⇔『工数』: 作業量・削減・見積もり文脈の『個数』は『工数』の疑い。"
        "\n- 『給食』⇔『休職』: 人事・不在・復帰文脈の『給食』は『休職』の疑い。"
        "\n- 『回収』⇔『改修』: システム・開発・セッション文脈の『回収』は『改修』の疑い。"
        "\n- 『転機』『天気』『転勤』⇔『転記』: データ・書類の書き写し文脈では『転記』の疑い。"
        "\n- 『配信』⇔『廃止』: 業務・工程を『なくす』文脈の『配信できる』は『廃止できる』の疑い。"
        "\n- 『御社』『弊社』『本社』『4社』: 話者の立場と文脈の整合を確認し、"
        "不整合なら正しい呼称を候補提示する（例: 相手企業を指す『本社』『4社』→『御社』）。"
        "\n\n【検出量】"
